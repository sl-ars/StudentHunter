...
import { Building2, MapPin, Phone, Mail, Globe, GraduationCap, Users } from "lucide-react"
...
export default function CampusProfilePage() {
  ...
  return (
    <ProtectedRoute roles={[USER_ROLES.CAMPUS]}>
                ...
                <Card className="border-none shadow-lg overflow-hidden">
                  ...
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="font-semibold">{profileData?.totalStudents || 0}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Active Programs</span>
                      <span className="font-semibold">{profileData?.activePrograms || 0}</span>
                    </div>
                    <div className="flex items-center justify-between">
                      <span className="text-muted-foreground">Partner Companies</span>
                      <span className="font-semibold">{profileData?.partnerCompanies || 0}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          handleInputChange("programs", e.target.value.split("\n").filter(Boolean))
                        }
                        className="min-h-[120px]"
                        placeholder="Enter each program on a new line"
                      />
                    </div>
